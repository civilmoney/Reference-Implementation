...
LABEL_JOIN_THE_REVOLUTION,Join the revolution,
TITLE_PEERS,Peers,
...
<li>I will hold in the highest esteem any person doing an unpleasant job in exchange for Civil Money.</li>
<li>I will endeavour to eliminate unpleasant jobs through the sharing of ideas, science and ingenuity.</li>
<li>I understand Civil Money holds no intrinsic value, and is an imperfect system. As such, the higher the cost of a good or service, the closer I will scrutinise a person's credit rating and transaction history, just as banks do today for a loan.</li>
</ol>
"",
...
LABEL_INSTALL_A_SERVER_INTRO,""The more servers, the stronger and more resilient the Civil Money network can become.
If you are in possession of a Windows or Linux server with a permanent IP address and
reliable high bandwidth network connection, please feel free to install an instance of the server. We apologise that
the following installation instructions are available in English only."",
...
HTML_ABOUT_4_1, ""Every person whether retired, studying, disabled or working receives the same generous basic income."",
...
HTML_ABOUT_5_2, ""Every user of Civil Money is a money lender. By merely accepting payment from a person with a low credit score or even a negative balance, you are extending respect to that person. You will get paid either way by simply accepting anybody's payment, but the question to ask is, <em>&quot;should I?&quot;</em><br/><br/><b>You</b> are the bank. The level of compassion towards a customer's personal circumstance is up to each individual business or seller."",
HTML_ABOUT_6_1, ""There is no such thing as physical cash."",
HTML_ABOUT_6_2, ""There are only publicly visible and verifiable balances and credit scores, which imply a level community good-standing."",
HTML_ABOUT_7_1, ""The value of one Civil Money is always equal to one hour of a person's time."",
HTML_ABOUT_7_2, ""The mathematical constant of time can prevent inflation, however goods and services must be priced appropriately. Civil Money only works if we spend wisely and scrutinise the fair value of items and services that we're purchasing (labour + materials + a reasonable margin) to stop things getting out of hand.
...
HTML_ABOUT_8_2, ""This means it is impossible for a minority to hoard cash as they do today.<br/>
<br/>Everybody is encouraged to spend their money early, which ensures the distribution of wealth and a happy and healthy economy.<br/>
<br/>Capitalism is not inhibited, however your capital can no longer be held long-term in the form of money. Instead it must be converted into physical assets and property."",
HTML_ABOUT_9_1, ""Because payments depreciate, your credit score automatically restores itself if you fall on hard times."",
HTML_ABOUT_9_2, ""Depreciation of account debits along with a perpetually replenishing basic income ensures that people retain their dignity in the event of financial disaster. Nobody need struggle without access to essential goods and services for an extended period of time, if at all."",
...
HTML_ABOUT_13_1, ""'Double spending' is allowed. As such, implicit dispute resolution is built-in."",
...
<h1>Shall we?</h1>"",
HTML_ABOUT_15_1, ""All you need is temporary access to the internet."",
