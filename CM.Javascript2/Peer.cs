...
namespace CM.JS {
    ...
    internal class Peer {
        ...
        private Retyped.dom.WebSocket _Socket;
        ...
        public Peer(Client owner,
            ...
            IsEndPointAnIP = System.Text.RegularExpressions.Regex.Match(parts[0], @"^\d+\.\d+.\d+.\d+$").Success;  
            if (IsEndPointAnIP) {
        ...
        public void BeginConnect(Action onConnected) {
            ...
            _Socket = new Retyped.dom.WebSocket(ep, Constants.WebSocketProtocol);
        ...
        public void SendAndReceive(string action, Message payload, string[] args, Action<Peer, Message> onResult) {
            BeginConnect(() => {
                ...
                if (_Socket == null || _Socket.readyState != Retyped.dom.WebSocket.OPEN_Static) {
